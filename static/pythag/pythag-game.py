...
async def main():
    ...
    global base_value, height_value, base_score, height_score, all_card_values, show_final_score, show_instructions, final_score, stage, selected_cards
    base_value = 0
    height_value = 0
    base_score = 0
    height_score = 0
    ...
    for i in range(num_cards_to_display):
        ...
        y = 80 + (card_height + card_margin) * (i // 5)  # 5 rows
    ...
    def update_score_and_cards_left():
        global base_score, height_score, base_value, height_value
    ...
    def reset_game():
        global stage, base_score, height_score, selected_cards, final_score, all_card_values, base_value, height_value, show_final_score, show_instructions
        stage = 1
        base_score = 0
        height_score = 0
        selected_cards = []
